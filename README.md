...
Subject: Malware Analysis Report: Mitigation of chrome
...
Summary:
The malware exhibited persistence mechanisms by adding to the Windows startup registry and communicating with a remote server. It was also running a process under the name .
